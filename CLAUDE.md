...
Arkana is a Model Context Protocol (MCP) server exposing 261 binary analysis tools to AI clients. It supports PE, ELF, and Mach-O formats with integrations for angr, capa, FLOSS, YARA, Binary Refinery, Qiling, and Speakeasy.
...
├── resource_monitor.py  # Process-level RSS/CPU monitoring (psutil daemon thread)
    └── mcp/                # MCP tool modules (261 tools across 58 files)
