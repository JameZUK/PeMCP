...
Arkana is a Model Context Protocol (MCP) server exposing 212 binary analysis tools to AI clients. It supports PE, ELF, and Mach-O formats with integrations for angr, capa, FLOSS, YARA, Binary Refinery, Qiling, and Speakeasy.
...
└── mcp/                # MCP tool modules (212 tools across 51 files)
