...
class TestApiNameDatabase:
    ...
    def test_database_file_exists(self):
        db_path = Path(__file__).resolve().parent.parent / "arkana" / "data" / "windows_api_names.json"
        assert db_path.exists(), "windows_api_names.json missing"

    def test_database_loads_valid_json(self):
        from arkana.mcp._helpers_api_hashes import _load_api_name_db
    ...
    def test_database_has_reasonable_count(self):
        from arkana.mcp._helpers_api_hashes import get_all_api_names
    ...
    def test_get_api_names_with_dll(self):
        from arkana.mcp._helpers_api_hashes import get_api_names_with_dll
...
class TestHashAlgorithms:
    ...
    def test_djb2_default_seed(self):
        from arkana.mcp._helpers_api_hashes import djb2_hash
    ...
    def test_djb2_adaptixc2_known_hashes(self):
        ...
        from arkana.mcp._helpers_api_hashes import compute_hash
    ...
    def test_ror13_default(self):
        from arkana.mcp._helpers_api_hashes import ror13_hash
    ...
    def test_crc32(self):
        from arkana.mcp._helpers_api_hashes import crc32_hash
        import binascii
    ...
    def test_fnv1a_default(self):
        from arkana.mcp._helpers_api_hashes import fnv1a_hash
...
class TestBuildHashLookup:
    ...
    def test_basic_lookup(self):
        from arkana.mcp._helpers_api_hashes import build_hash_lookup
