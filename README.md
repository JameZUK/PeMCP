...
[![MCP Tools](https://img.shields.io/badge/MCP_Tools-226-purple.svg)](docs/tools-reference.md)
...
| **[Tools Reference](docs/tools-reference.md)** | Complete catalog of all 226 MCP tools organised by category |
