...
### Added
- Three C2 framework identification tools: `identify_c2_framework()`, `list_c2_signatures()`, `verify_c2_attribution()` — match binary indicators against a 123-family signature knowledge base (`pemcp/data/c2_signatures.yaml`) for automated C2 attribution with confidence scoring.
