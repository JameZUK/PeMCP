# PeMCP Learning Curriculum

Structured modules for teaching reverse engineering using PeMCP tools.
...
- Read PeMCP's annotated disassembly output
...
- Read PeMCP's CFG output and trace execution paths
...
- Use PeMCP's automated unpacking cascade
...
**Reference**: [unpacking-guide.md](../pemcp-analyze/unpacking-guide.md)
