...
MCP server with 250 tools spanning static analysis, dynamic emulation, data-flow
...
- [tooling-reference.md](tooling-reference.md) — Complete 250-tool catalog with "Use When" and "Prefer/Avoid" guidance
