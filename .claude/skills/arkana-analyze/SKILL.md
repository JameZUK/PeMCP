...
MCP server with 230 tools spanning static analysis, dynamic emulation, data-flow
...
- [tooling-reference.md](tooling-reference.md) — Complete 230-tool catalog with "Use When" and "Prefer/Avoid" guidance
