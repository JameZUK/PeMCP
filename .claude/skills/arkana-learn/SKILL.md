...
description: >
  ...
  users through hands-on analysis or structured lessons using Arkana's 229
...
- **NEVER use Bash, shell commands, or write scripts** (see HARD CONSTRAINTS).
  Use Arkana's 229 tools for every operation. Batch parameters process multiple items.
...
- [tooling-reference.md](../arkana-analyze/tooling-reference.md) — Complete
  229-tool catalog with "Use When" and "Prefer/Avoid" guidance
