...
description: >
  ...
  users through hands-on analysis or structured lessons using Arkana's 259
...
- **NEVER use Bash, shell commands, or write scripts** (see HARD CONSTRAINTS).
  Use Arkana's 259 tools for every operation. Batch parameters process multiple items.
