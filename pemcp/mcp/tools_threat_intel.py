...
def _build_navigator_layer(techniques: List[Dict]) -> Dict[str, Any]:
    ...
    return {
        ...
        "description": f"Auto-generated from PeMCP analysis — {len(techniques)} techniques",
...
id: pemcp-proc-{sha256[:8]}
status: experimental
description: >
    DRAFT detection rule generated by PeMCP for sample {sha256[:16]}...
    Confidence: {confidence}. Requires analyst review before deployment.
references:
    - 'Generated by PeMCP generate_sigma_rule'
author: PeMCP (auto-generated)
date: {date_str}
logsource:
