...
async def scan_for_embedded_files(
    ...
    def _scan_cli():
        ...
        # binwalk v3 treats '--' as a literal filename, so we omit it.
        # Use --signature explicitly for clarity across binwalk versions.
        proc = subprocess.run(
            ["binwalk", "--signature", "--quiet", state.filepath],
