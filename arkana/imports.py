...
except (OSError, ValueError) as e_floss_setup_generic:
...
if FLOSS_SETUP_OK:
    try:
        ...
        FLOSS_ANALYSIS_OK = False
    except (OSError, ValueError) as e_floss_analysis_generic:
...
try:
    ...
    from dncil.cil.body.reader import read_method_body_from_bytes  # noqa: F401
