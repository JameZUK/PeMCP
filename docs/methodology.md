...
When you give Arkana a prompt like *"Analyse this binary and tell me what it does"*, the AI doesn't call a single tool and report the output. It executes a structured, multi-phase methodology -- the same workflow a professional malware analyst follows, orchestrated automatically across 294 specialised tools.
...
- [Tools Reference](tools-reference.md) -- Complete catalog of all 294 tools
