...
Arkana ships with an **analysis skill**  - a structured workflow that teaches Claude Code how to use Arkana's 229 tools methodically, rather than relying on the model to figure it out from tool descriptions alone.
...
- **Comprehensive tool coverage**  - A complete reference for all 229 tools organised by use case, plus specialised guides for C2 config extraction, unpacking strategies, and safe online research methodology.
...
tooling-reference.md  # Complete 229-tool catalog by use case
...
| [`tooling-reference.md`](../.claude/skills/arkana-analyze/tooling-reference.md) | Complete catalog of all 229 MCP tools organised by use case with brief descriptions and key parameters |
