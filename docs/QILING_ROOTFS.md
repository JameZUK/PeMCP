...
> **Note:** Registry hive stubs are auto-generated by Arkana — you do not need
...
ARKANA_ROOTFS=/path/to/my/rootfs ./run.sh

# Or via docker compose
ARKANA_ROOTFS=/path/to/my/rootfs docker compose up arkana-http
```
...
| Registry hives | `Windows/registry/` | **Auto-generated** by Arkana |
...
Arkana auto-generates registry hive stubs. If you see this error, the rootfs
