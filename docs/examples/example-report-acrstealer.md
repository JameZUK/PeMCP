...
The analysis required no external tools or custom scripts — every step from acquisition through to cipher reversal was performed exclusively through Arkana's 281 MCP tools, demonstrating the platform's capability for **end-to-end malware analysis of non-trivial, actively-deployed threats**.
