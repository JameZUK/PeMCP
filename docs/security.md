...
- **Integration tests** (`mcp_test_client.py`)  - End-to-end tests for all 256 MCP tools against a running server, organised into 19 test categories with pytest markers.
